...
from src.data.components.imagefolder import ImageFolderWithoutClass


class CelebaHQDDPMDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            testset = ImageFolderWithoutClass(
                self.hparams.data_dir,
                transform=self.val_affine_transforms,
            )
            self.data_train = testset
