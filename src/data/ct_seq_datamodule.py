...
from src.data.components.mayo_ct_dataset_seq import MayoSequenceCTData
...
class CTDDPMDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.train_affine_transforms = transforms.Compose(
            [
                transforms.Resize(
                    size=resolution, interpolation=transforms.InterpolationMode.BILINEAR, antialias=True
                ),
