...
from src.data.components.mayo_proj_dataset import MayoRealProjectionData
...
class CTDDPMDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            # trainset = MayoRealProjectionData(
            #     self.hparams.data_dir,
            #     split="train",
            #     affine_transforms=self.train_affine_transforms,
            #     image_transforms=self.image_transforms,
            # )
            testset = MayoRealProjectionData(
                self.hparams.data_dir,
                image_size=self.hparams.resolution,
                voxel_size=self.hparams.voxel_size,
                fbp_filter=self.hparams.fbp_filter
            )
