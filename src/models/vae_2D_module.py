...
class VAEModelLitModule(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log_dict({"g_loss": aeloss, "d_loss": discloss, "g_lr": g_sch.get_last_lr()[0]}, prog_bar=True)
        # return discloss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if batch_idx == 0:
            ...
            reconstructed_grid_images = make_grid(xrec.view(-1, 1, *x.shape[-2:]), nrow=8, normalize=True, value_range=(-1, 1))
            self.logger.experiment.add_image(
                "val/reconstructed",
